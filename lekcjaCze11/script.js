class Tabs {
    ...
    getLastTabNr() {
        return parseInt([...this.getTabsBtn()].pop().dataset.tabNr);
    }
    ...
    showTabAndContent(button, TabsBtn) {
        ...
        let wasTabActive = false;
        if (button.classList.contains("tabs__btn--active")) wasTabActive = true;
        this.removeAllActiveFromTabs(TabsBtn);
        if (!wasTabActive) button.classList.add("tabs__btn--active");
        
        this.getTabsContent().forEach(content => {
            let contentNr = content.dataset.contentNr;
            let wasActive = false;
            if (content.classList.contains("tabs__content--active")) wasActive = true;
            content.classList.remove("tabs__content--active");
            if (contentNr === tabNr && !wasActive) {
    ...
    addNewDeleteBtn(newButton) {
        ...
        newDeleteBtn.src = "img/delete.png";
