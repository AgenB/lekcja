import { GAME_STATE, GAME, $container, BtnGameOver } from "./global.js";
import { setPosition, rectsIntersect } from "./tools.js";
import { destroyEnemy, destroyAllEnemy } from "./enemies.js";
...
function destroyAllEnemyLaser(){
  const allEnemyLaser = document.querySelectorAll('.enemy-laser');
  
  allEnemyLaser.forEach(enemyLaser => {
    $container.removeChild(enemyLaser);
  })
